...
namespace BlazorWishList.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WisherId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WishListItems_AspNetUsers_PurchaserId",
                        column: x => x.PurchaserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_WishListItems_AspNetUsers_WisherId",
                        column: x => x.WisherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishListItem",
                table: "WishListItems",
                columns: new[] { "IsDeleted", "WisherId", "IsPurchased", "PurchaserId" });

            migrationBuilder.CreateIndex(
                name: "IX_WishListItems_PurchaserId",
                table: "WishListItems",
                column: "PurchaserId");

            migrationBuilder.CreateIndex(
                name: "IX_WishListItems_WisherId",
                table: "WishListItems",
                column: "WisherId");
        }
